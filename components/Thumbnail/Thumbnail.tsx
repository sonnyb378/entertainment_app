    ...
    return (
        ...
        >
                ...
                <div 
                    ...
                    className={`${ expand ? "flex opacity-100 z-[3000]" : "flex opacity-0 z-[1152] scale-[50%]"} 
                ...
                >
                    <div className="flex flex-col items-center justify-start w-full h-[100%]">
                        {
            ...
            >
                <div className="flex flex-col items-center justify-start w-full h-[100%]">
                    <span className={`${isHover ? "flex" : "invisible"} z-[2000] items-center justify-center absolute top-2 left-2 px-2 text-[10px] bg-black`}>
